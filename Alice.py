...
message_label = tk.Label(alice_window, text="Enter your message:",font=("Arial", 11))
message_label.pack(pady=10)
message_label.pack()

message_entry = tk.Entry(alice_window, font=("Arial", 12))
message_entry.pack(pady=5)
message_entry.pack()

send_button = tk.Button(alice_window, text="Send Message", command=send_message,
                        font=("Arial", 12), bg="purple", fg="white", activebackground="darkblue", padx=10, pady=5)
send_button.pack(pady=12)
send_button.pack()

status_label = tk.Label(alice_window, text="Server not started",font=("Arial", 12), padx=100, pady=100)
status_label.pack()
